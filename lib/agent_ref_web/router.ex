defmodule AgentRefWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {AgentRefWeb.Layouts, :root}
  ...
  # scope "/api", AgentRefWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:agent_ref, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: AgentRefWeb.Telemetry
  ...
  scope "/", AgentRefWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{AgentRefWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", AgentRefWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{AgentRefWeb.UserAuth, :ensure_authenticated}] do
